...
enum class SkyblockIsland(
    ...
    KUUDRA("kuudra", "Kuudra", listOf("Kuudra")),
    CATACOMBS("catacombs", "The Catacombs", listOf("Catacombs")),
    DUNGEON_HUB("dungeon_hub", "Dungeon Hub", listOf("Dungeon Hub")),
    CRYSTAL_HOLLOWS("crystal_hollows", "Crystal Hollows", listOf("Crystal Hollows")),
    DWARVEN_MINES("dwarven_mines", "Dwarven Mines", listOf("Dwarven Mines")),
    DEEP_CAVERNS("deep_caverns", "Deep Caverns", listOf("Deep Caverns")),
    GOLD_MINE("gold_mine", "Gold Mine", listOf("Gold Mine")),
    CRIMSON_ISLE("crimson_isle", "Crimson Isle", listOf("Crimson Isle")),
    THE_RIFT("the_rift", "The Rift", listOf("The Rift")),
    THE_END("the_end", "The End", listOf("The End")),
    SPIDERS_DEN("spiders_den", "Spider's Den", listOf("Spider's Den", "Spiders Den")),
    JERRYS_WORKSHOP("jerrys_workshop", "Jerry's Workshop", listOf("Jerry's Workshop", "Winter Island")),
    ...
    companion object {
        ...
        fun match(areaText: String): SkyblockIsland? {
            val hay = areaText.lowercase()
